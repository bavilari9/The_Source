...
export function  Header() {
  ...
  <div id="about"className="hero-content jumbotron text-initial">
      ...
      <p><b>THE SOURCE</b> is the premier database highlighting Latino actors, actresses, writers, and directors who have recently worked on major network and OTT content, as well as the highest-grossing box office films. We offer a solution to the misconception that “there is a lack of Latino talent available in the film/tv industry,” through <b>the go-to tool for content creators seeking to engage Latino talent —and by extension, Latino audiences.</b></p>
      <p>Rest assured, every individual in our database has already been vetted and hired by leading networks or studios. </p>
      {/* <p>Starting Summer 2019, we have decided to release this data publicly to create awareness and empower our friends in the entertainment industry with data on where to invest to attract the cohort with the youngest demographic and second fastest growth rate.</p> */}
